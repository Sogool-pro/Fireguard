...
const String PHONE_NUMBERS[] = {"+639277314065", "+639338765297", "+639306702771"};
...
void sendSMSAlert(NodeData* nodeData, NodeAlert* nodeAlert) {
  // Only send SMS if we're in alert state and buzzer is not silenced
  if (nodeData->alertLevel == ALERT && !nodeAlert->buzzerSilenced) {
